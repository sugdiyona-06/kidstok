...
-- Format: sayt faqat vertikal qisqa videolar (Shorts) bilan ishlaydi.
-- (Ustun eski versiyalar bilan moslik uchun qoladi; hamma video 'short' bo'ladi.)
